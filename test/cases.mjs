...
export const cases = [
	...
	['company_id', { id: 'co_id/with #?', deep: true }, '/company/id/co_id%2Fwith%20%23%3F', { deep: 'true' }],
	['company_search', { query: 'Café & Labs', country: 'US', limit: 3, cursor: 'page+/=?', deep: true }, '/company', { q: 'Café & Labs', country: 'US', limit: '3', cursor: 'page+/=?', deep: 'true' }],
	['company_search', { domain: 'https://www.example.com/a?b=c&d=e', deep: false }, '/company', { domain: 'https://www.example.com/a?b=c&d=e' }],
	['company_search', { ticker: 'BRK/B', exchange: 'NYSE', country: 'US' }, '/company', { ticker: 'BRK/B', exchange: 'NYSE', country: 'US' }],
	['company_search', { identifier: '0000081061', authority: 'SEC' }, '/company', { identifier: '0000081061', authority: 'SEC' }],
	['company_coverage', {}, '/company/directory/coverage'],
	...
	['time_zones', { query: 'New York' }, '/time/zones', { q: 'New York' }],
	['time', { timezone: 'UTC', targets: ['UTC', 'Asia/Tokyo', 'UTC'] }, '/time/UTC', { targets: 'UTC,Asia/Tokyo,UTC' }],
	['time', { lat: 0, lon: 0, targets: ['UTC', 'Asia/Tokyo', 'UTC'], at: '2026-11-01T01:30', disambiguation: 'later' }, '/time', { lat: '0', lon: '0', targets: 'UTC,Asia/Tokyo,UTC', at: '2026-11-01T01:30', disambiguation: 'later' }],
	['time', {}, '/time'],
	['time', { timezone: 'America/New_York', at: '2026-08-01T12:00:00', to: 'Asia/Tokyo' }, '/time/America%2FNew_York', { at: '2026-08-01T12:00:00', to: 'Asia/Tokyo' }],
	['time', { lat: 0, lon: 0, at: '2026-08-01T12:00:00Z', to: 'Asia/Tokyo' }, '/time', { lat: '0', lon: '0', at: '2026-08-01T12:00:00Z', to: 'Asia/Tokyo' }],
